window.__XINGCHEN_COMPETITOR_DATA__ = {
  updatedAt: "2026-07-13 17:35",
  snapshotDate: "2026-07-13",
  note: "本文件是竞品看板的外部增量数据入口。更新 events、news、sources、competitors 或 strategies 后，页面打开时会自动合并最新数据。",
  sources: {
    baiduModel: {
      note: "官方模型更新页，更新时间 2026-07-09；7 月记录 Kimi-K2.5、MiniMax-M2.5 退役，6 月记录 GLM-5.2 上新。"
    },
    baiduCodingPlan: {
      note: "2026-06-25 起停止旧 Coding Plan 续费，7 月初逐步迁移到 Token Plan 个人版。"
    },
    aliyunModels: {
      note: "公开模型目录展示千问及三方模型，覆盖文本、图像、视频、3D、音频与语音等能力。"
    },
    siliconRelease: {
      note: "更新公告覆盖模型下线、版本切换、价格调整、实名要求、调用限额与服务迁移；最新可见记录到 2026-06-05。"
    },
    tencentTione: {
      note: "腾讯云 TI-ONE 文档强调从数据接入、模型训练、模型管理到模型服务的全流程，并提供 DeepSeek、混元等实践教程。"
    },
    huaweiModelArts: {
      note: "华为云 ModelArts 成长地图更新时间为 2025-09-24，入口关联 ModelArts、MaaS 模型即服务和 AgentArts 智能体平台。"
    },
    ftChinaModelCost: {
    ...
    wechatVolcArkSearch: {
      ...
      type: "wechat",
      note: "用于追踪火山方舟相关公众号文章、客户案例和产品传播口径；具体文章建议后续人工确认。"
    },
    wechatQianfanSearch: {
      ...
      type: "wechat",
      note: "用于追踪千帆相关公众号文章、活动传播、案例和套餐解读；具体文章建议后续人工确认。"
    },
    wechatBailianSearch: {
      ...
      type: "wechat",
      note: "用于追踪阿里百炼、通义千问相关公众号文章、模型宣传和生态案例；具体文章建议后续人工确认。"
    },
    wechatSiliconSearch: {
      ...
      type: "wechat",
      note: "用于追踪硅基流动价格、模型接入、DeepSeek 调用生态等公众号讨论；具体文章建议后续人工确认。"
    }
  },
  competitors: [
    {
  ...
  news: [
    ...
    },
    {
      ...
      categories: ["coding", "business", "governance"],
      priority: "medium",
    ...
    },
    {
      ...
      categories: ["model", "business", "platform"],
      priority: "high",
    ...
    },
    {
      ...
      categories: ["platform", "multimodal"],
      priority: "high",
    ...
    },
    {
      ...
      categories: ["platform", "business", "agent"],
      priority: "high",
    ...
    },
    {
      ...
      categories: ["model", "multimodal", "platform"],
      priority: "medium",
    ...
    },
    {
      ...
      categories: ["agent", "tools", "business"],
      priority: "medium",
    ...
    },
    {
      ...
      categories: ["model", "agent", "platform"],
      priority: "medium",
