window.__XINGCHEN_COMPETITOR_DATA__ = {
  "updatedAt": "2026-09-01 05:44:11",
  "snapshotDate": "2026-08-31",
  "note": "自动刷新已运行：2026-09-01 05:44:11（北京时间），本次按“平台自己的官方更新记录”口径总结 2026-08-31 的竞品动态。官方更新记录 0 条，新闻/公众号线索 2 条，官方模型更新 20 条。",
  "sources": {
    "baiduModel": {
  ...
  "news": [
    {
      ...
      "summary": "媒体信息提到：...热 29 港姐冠军自曝“父母不支持我入行” 30 吴易昺闯入美网男单第二轮 辅助模式 豆包 系列 模型 体验一致:无论是通用对话还是语...。这条信息主要指向模型供给、图像视频语音、生态/客户案例。",
      ...
      "evidence": "命中“火山方舟”：…热 29 港姐冠军自曝“父母不支持我入行” 30 吴易昺闯入美网男单第二轮 辅助模式 豆包 系列 模型 体验一致:无论是通用对话还是语音合成场景, 豆包 系列的输出风格和稳定性在火山方舟上能得到最完整释放。 实操建议: 业务和流量已经深度绑定字节云生态的,首选火山方舟能减少跨云调用的公网流量费用和网络抖动。 如果主要需求是“跨多家国产模型灵活切换”,… ,…",
      "categories": [
        "model",
        "multimodal",
        "business"
  ...
  "monitorRuns": [
    ...
    },
    {
      ...
      "runDateTime": "2026-08-13 04:04:10",
      "sourcesChecked": 27,
      "exactMatches": 0,
      "publishedCandidates": 1,
      "candidates": 24,
