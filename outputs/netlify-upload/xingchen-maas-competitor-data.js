window.__XINGCHEN_COMPETITOR_DATA__ = {
  "updatedAt": "2026-09-03 03:38:06",
  "snapshotDate": "2026-09-02",
  "note": "自动刷新已运行：2026-09-03 03:38:06（北京时间），本次按“平台自己的官方更新记录”口径总结 2026-09-02 的竞品动态。官方更新记录 0 条，新闻/公众号线索 2 条，官方模型更新 20 条。",
  "sources": {
    "baiduModel": {
  ...
  "news": [
    {
      ...
      "summary": "媒体信息提到：...29 吉隆口岸泥石流堆积物最高达16米 30 江西把校服选择权还给学生和家长 辅助模式 豆包 系列 模型 体验一致:无论是通用对话还是...。这条信息主要指向模型供给、图像视频语音、生态/客户案例。",
      ...
      "evidence": "命中“火山方舟”：…29 吉隆口岸泥石流堆积物最高达16米 30 江西把校服选择权还给学生和家长 辅助模式 豆包 系列 模型 体验一致:无论是通用对话还是语音合成场景, 豆包 系列的输出风格和稳定性在火山方舟上能得到最完整释放。 实操建议: 业务和流量已经深度绑定字节云生态的,首选火山方舟能减少跨云调用的公网流量费用和网络抖动。 如果主要需求是“跨多家国产模型灵活切换”,… …",
      "categories": [
        "model",
        "multimodal",
        "business"
